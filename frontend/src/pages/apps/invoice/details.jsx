...
function PDFIconButton({ list, currentPalette, scheme }) {
  return (
    <PDFDownloadLink
      document={<ExportPDFView list={list} themeMode={scheme} currentPalette={currentPalette} />}
...
export default function Details() {
  ...
  const minimalDarkPrintStyles = `
  @page { margin: 0; }
  @media print {
    html, body, #print {
      background: ${currentPalette.background.paper};
...
`;
  ...
  const reactToPrintFn = useReactToPrint({
    contentRef,
    pageStyle: colorScheme === ThemeMode.DARK ? minimalDarkPrintStyles : undefined
  });
          ...
          <Box sx={{ p: 2.5, pb: 0 }}>
            ...
            >
              <Stack direction="row" sx={{ gap: 1, justifyContent: 'flex-end' }}>
                ...
                {isLoader ? <Button loading>X</Button> : <PDFIconButton {...{ list, scheme, currentPalette }} />}
...
PDFIconButton.propTypes = { list: PropTypes.any, currentPalette: PropTypes.any, scheme: PropTypes.any };
