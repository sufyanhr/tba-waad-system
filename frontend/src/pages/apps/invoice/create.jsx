...
function CreateForm({ lists, invoiceMaster }) {
  ...
  const [country, setCountry] = useState(invoiceMaster.countries[0] || null);
                      ...
                      <>
                        ...
                        <Grid container sx={{ justifyContent: 'space-between' }}>
                          ...
                          <Grid size={{ xs: 12, md: 4 }}>
                            <Grid container spacing={2} sx={{ pt: 2.5, pb: 2.5, justifyContent: 'space-between' }}>
                              <Grid size={6}>
                                <Stack sx={{ gap: 1 }}>
              ...
              <Grid size={12}>
                <Stack sx={{ gap: 1 }}>
                  ...
                  <TextField
                    ...
                    sx={{ width: '100%' }}
                    slotProps={{
                      htmlInput: { maxLength: notesLimit },
                      formHelperText: { sx: { mt: -2.25, mr: 0.75, color: 'secondary.400', display: 'flex', justifyContent: 'flex-end' } }
                    }}
                  />
                </Stack>
              </Grid>
