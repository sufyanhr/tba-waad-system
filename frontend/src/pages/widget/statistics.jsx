  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid size={{ xs: 12, lg: 4 }}>
        <UserCountCard primary="Daily user" secondary="1,658" iconPrimary={ContactsOutlined} color="success.main" />
      </Grid>
      <Grid size={{ xs: 12, lg: 4, sm: 6 }}>
        <UserCountCard primary="Daily page view" secondary="1K" iconPrimary={FileProtectOutlined} color="primary.main" />
      </Grid>
      <Grid size={{ xs: 12, lg: 4, sm: 6 }}>
        <UserCountCard primary="Last month visitor" secondary="5,678" iconPrimary={RedditOutlined} color="warning.main" />
      </Grid>
