...
export default function Buttons() {
  ...
  const EnvironmentIcon = (
    <EnvironmentTwoTone
      twoToneColor={[theme.palette.info.main, colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.info.dark, 0.5) : '']}
    />
  );
...
<Button variant="outlined" color="info" startIcon={<EnvironmentTwoTone twoToneColor={[theme.palette.info.main, colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.info.dark, 0.5) : '']} />}>Address</Button>
...
<IconButton variant="outlined" color="info">
  <EnvironmentTwoTone twoToneColor={[theme.palette.info.main, colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.info.dark, 0.5) : '']} />
</IconButton>
            ...
            <Stack sx={{ gap: 3 }}>
              ...
              <MainCard title="With Icon" codeString={withIconButtonCodeString}>
                <Grid container spacing={2}>
                  ...
                  <Grid>
                    <Button variant="outlined" color="info" startIcon={EnvironmentIcon}>
                      Address
                    </Button>
                  </Grid>
                  <Grid>
