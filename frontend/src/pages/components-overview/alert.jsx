...
<Alert color="error" variant="border" icon={<BugFilled />}>
  ...
  const outlinedAlertCodeString = `<Alert color="primary" variant="outlined" icon={<QuestionCircleTwoTone twoToneColor={[theme.palette.primary.main, colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.primary.darker, 0.5) : '']}/>}>
  Primary Text
</Alert>
<Alert color="secondary" variant="outlined" icon={<DatabaseTwoTone twoToneColor={[theme.palette.secondary.main, colorScheme === ThemeMode.DARK ? theme.palette.secondary.dark : '']} />}>
  Secondary Text
</Alert>
<Alert color="success" variant="outlined" icon={<CheckSquareTwoTone twoToneColor={[theme.palette.success.main, colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.success.dark, 0.5) : '']} />}>
  Success Text
</Alert>
<Alert color="warning" variant="outlined" icon={<WarningTwoTone twoToneColor={[theme.palette.warning.main, colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.warning.dark, 0.5) : '']} />}>
  Warning Text
</Alert>
<Alert color="info" variant="outlined" icon={<InfoCircleTwoTone twoToneColor={[theme.palette.info.main, colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.info.dark, 0.5) : '']} />}>
  Info Text
</Alert>
<Alert color="error" variant="outlined" icon={<BugTwoTone twoToneColor={[theme.palette.error.main, colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.error.dark, 0.5) : '']} />}>
  Error Text
</Alert>`;
              ...
              <MainCard title="Actions" codeString={actionsAlertCodeString}>
                <Stack sx={{ gap: 2, width: 1 }}>
                  <Alert
                    ...
                    onClose={() => {}}
                    sx={(theme) => ({
                      '& .MuiIconButton-root:focus-visible': { outline: `2px solid ${theme.vars.palette.success.dark}`, outlineOffset: 2 }
                    })}
                  >
                    Success Text
                  </Alert>
              ...
              <MainCard title="Outlined" codeString={outlinedAlertCodeString}>
                <Stack sx={{ gap: 2, width: 1 }}>
                  ...
                  <Alert
                    ...
                    icon={
                      <DatabaseTwoTone
                        twoToneColor={[theme.palette.secondary.main, colorScheme === ThemeMode.DARK ? theme.palette.secondary.dark : '']}
                      />
                    }
                  >
                    Secondary Text
                    ...
                    icon={
                      <CheckSquareTwoTone
                        twoToneColor={[
                          ...
                          colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.success.dark, 0.5) : ''
                        ]}
                      />
                    }
                  >
                    ...
                    icon={
                      <WarningTwoTone
                        twoToneColor={[
                          ...
                          colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.warning.dark, 0.5) : ''
                        ]}
                      />
                    }
                  >
                    ...
                    icon={
                      <InfoCircleTwoTone
                        twoToneColor={[
                          ...
                          colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.info.dark, 0.5) : ''
                        ]}
                      />
                    }
                  >
                    ...
                    icon={
                      <BugTwoTone
                        twoToneColor={[
                          ...
                          colorScheme === ThemeMode.DARK ? withAlpha(theme.palette.error.dark, 0.5) : ''
                        ]}
                      />
                    }
                  >
