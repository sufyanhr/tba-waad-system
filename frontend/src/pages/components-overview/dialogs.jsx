...
<Dialog onClose={handleClose} open={open}>
  <Grid
    container
    spacing={2}
    sx={{ borderBottom: '1px solid {theme.vars.palette.divider}', alignItems:'center', justifyContent:'space-between' }}
  >
    <Grid item>
...
<Dialog fullScreen open={open} onClose={handleClose} slots={{ transition: PopupTransition }}>
