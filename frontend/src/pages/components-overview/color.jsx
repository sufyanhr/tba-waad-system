            ...
            <MainCard title="Info Color">
              <Stack>
                <ColorBox
                  ...
                  dark
                />
                <ColorBox bgcolor="info.light" data={{ label: 'Cyan-4', color: `${currentPalette.info.light}` }} title="info.light" dark />
                <ColorBox bgcolor="info.main" data={{ label: 'Cyan-6', color: `${currentPalette.info.main}` }} title="info.main" main />
                <ColorBox bgcolor="info.dark" data={{ label: 'Cyan-8', color: `${currentPalette.info.dark}` }} title="info.dark" />
                <ColorBox bgcolor="info.darker" data={{ label: 'Cyan-10', color: `${currentPalette.info.darker}` }} title="info.darker" />
              </Stack>
            </MainCard>
          </Grid>
        </Grid>
