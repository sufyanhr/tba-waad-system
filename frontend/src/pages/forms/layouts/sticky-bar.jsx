      ...
      <Grid size={12}>
        <MainCard content={false} sx={{ overflow: 'visible' }}>
          <CardActions
            sx={{
              position: 'sticky',
              top: state.menuOrientation === MenuOrientation.VERTICAL ? 60 : 120,
          ...
          <CardContent>
            <Grid container spacing={3} sx={{ alignItems: 'center' }}>
              ...
              <Grid size={12}>
                <Grid container spacing={{ xs: 1, sm: 2 }} sx={{ alignItems: 'flex-start' }}>
                  <Grid size={{ xs: 12, sm: 3, lg: 4 }} />
                  <Grid size={{ xs: 12, sm: 9, lg: 6 }}>
                    <Typography variant="h5" sx={{ mb: { xs: 1, sm: 3 } }}>
                      A. Personal Info:
                    </Typography>
                  </Grid>
                  <Grid sx={{ pt: { xs: 2, sm: 1.25 } }} size={{ xs: 12, sm: 3, lg: 4 }}>
              ...
              <Grid size={12}>
                <Grid container spacing={{ xs: 1, sm: 2 }} sx={{ alignItems: 'flex-start' }}>
                  ...
                  <Grid sx={{ pt: { xs: 2, sm: 0.75 } }} size={{ xs: 12, sm: 3, lg: 4 }}>
