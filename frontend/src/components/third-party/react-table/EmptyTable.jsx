...
export default function EmptyTable({ msg }) {
  ...
  const grey400 = greyVars[400] || '#bdbdbd';
  const grey600 = greyVars[600] || '#757575';
      ...
      <svg width="120" height="100" viewBox="0 0 184 152" aria-hidden focusable="false">
        <g fill="none" fillRule="evenodd">
          <g transform="translate(24 31.67)">
            <ellipse
              fill={isDarkMode ? grey400 : grey200}
            ...
            />
            <path
              fill={isDarkMode ? grey600 : grey400}
            ...
            />
            <path
              fill={isDarkMode ? grey700 : grey200}
