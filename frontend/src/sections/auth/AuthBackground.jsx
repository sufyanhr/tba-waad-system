    ...
    >
      <svg width="100%" height="calc(100vh - 175px)" viewBox="0 0 405 809" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill={primaryVars.light ?? theme.palette?.primary?.light ?? '#90caf9'}
        />
        <path
          ...
          fill={successVars.light ?? theme.palette?.success?.light ?? '#81c784'}
          opacity="0.6"
        />
        <path
          ...
          fill={errorVars.lighter ?? theme.palette?.error?.lighter ?? '#ffebee'}
          opacity={colorScheme === ThemeMode.DARK ? '0.9' : '1'}
        />
      </svg>
    </Box>
  );
