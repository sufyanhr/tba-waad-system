...
export default function ControlledTreeView() {
  ...
  const ExpandIcon = ({ ownerState, ...props }) => <RightOutlined {...props} />;
  const CollapseIcon = ({ ownerState, ...props }) => <DownOutlined {...props} />;

  const handleToggle = (_event, itemIds) => {
    setExpanded(itemIds);
  };

  const handleSelect = (_event, itemIds) => {
    setSelected(itemIds);
  };
