  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        background: '#aab4be',
        ...theme.applyStyles('dark', { background: '#8796A5' })
      }
    }
  },
  '& .MuiSwitch-thumb': {
    ...
    ...theme.applyStyles('dark', { background: '#003892' })
  },
  '& .MuiSwitch-track': {
    opacity: 1,
    background: '#aab4be',
...
const IOSSwitch = styled((props) => <Switch focusVisibleClassName=".Mui-focusVisible" disableRipple {...props} />)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        ...
        opacity: 1,
        border: 0,
        ...theme.applyStyles('dark', { background: '#2ECA45' })
      },
    ...
    '&.Mui-disabled .MuiSwitch-thumb': {
      ...
      ...theme.applyStyles('dark', { color: theme.vars.palette.grey[600] })
    },
    '&.Mui-disabled + .MuiSwitch-track': {
      opacity: 0.7,
  ...
  '& .MuiSwitch-track': {
    ...
    ...theme.applyStyles('dark', { background: '#39393D' })
  }
}));
...
const AntSwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        background: '#1890ff',
        ...theme.applyStyles('dark', { background: '#177ddc' })
      }
    }
  },
  '& .MuiSwitch-thumb': {
  ...
  '& .MuiSwitch-track': {
    ...
    boxSizing: 'border-box',
    ...theme.applyStyles('dark', { background: 'rgba(255,255,255, .35)' })
  }
}));
