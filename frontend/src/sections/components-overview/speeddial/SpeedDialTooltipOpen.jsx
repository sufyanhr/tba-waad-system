...
export default function SpeedDialTooltipOpen() {
  ...
  const iconColor = colorScheme === ThemeMode.DARK ? theme.palette.grey[300] : theme.palette.grey[600];
  const iconFillColor = colorScheme === ThemeMode.DARK ? theme.palette.grey[500] : '';

  // fab action options
  const actions = [
    { icon: <CopyTwoTone twoToneColor={[iconColor, iconFillColor]} style={{ fontSize: '1.15rem' }} />, name: 'Copy' },
    { icon: <SaveTwoTone twoToneColor={[iconColor, iconFillColor]} style={{ fontSize: '1.15rem' }} />, name: 'Save' },
    { icon: <PrinterTwoTone twoToneColor={[iconColor, iconFillColor]} style={{ fontSize: '1.15rem' }} />, name: 'Print' },
    { icon: <ShareAltOutlined style={{ color: iconColor, fontSize: '1.15rem' }} />, name: 'Share' },
    { icon: <HeartTwoTone twoToneColor={[iconColor, iconFillColor]} style={{ fontSize: '1.15rem' }} />, name: 'Like' }
  ];
