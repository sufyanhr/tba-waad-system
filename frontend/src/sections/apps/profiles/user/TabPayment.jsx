          ...
          <Stack direction="row" sx={{ gap: 1.25, alignItems: 'center', justifyContent: 'space-between' }}>
            <Stack direction="row" sx={{ gap: 1 }}>
              <Button
                variant="outlined"
                color="secondary"
                sx={{ ...buttonStyle, ...(method === 'card' ? { borderColor: 'secondary.200' } : { borderColor: 'transparent' }) }}
              ...
              <Button
                variant="outlined"
                color="secondary"
                sx={{ ...buttonStyle, ...(method === 'paypal' ? { borderColor: 'secondary.200' } : { borderColor: 'transparent' }) }}
