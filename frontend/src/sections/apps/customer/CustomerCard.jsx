    ...
    <>
      <MainCard sx={{ height: 1, '& .MuiCardContent-root': { height: 1, display: 'flex', flexDirection: 'column' } }}>
        <Grid id="print" container spacing={2.25}>
                ...
                <List sx={{ p: 0, overflow: 'hidden', '& .MuiListItem-root': { px: 0, py: 0.5 } }}>
                  <ListItem sx={{ alignItems: 'center' }}>
                    ...
                    <ListItemText
                      ...
                      slotProps={{ primary: { color: 'secondary', width: 'auto', sx: { overflow: 'hidden', textOverflow: 'ellipsis' } } }}
                    />
                  </ListItem>
                  <ListItem sx={{ alignItems: 'center' }}>
                    <ListItemIcon>
                    ...
                    <ListItemText
                      slotProps={{ primary: { width: 'auto', sx: { overflow: 'hidden', textOverflow: 'ellipsis' } } }}
                      primary={
          ...
          <Grid size={12}>
            <Stack direction="row" component="ul" sx={{ listStyle: 'none', flexWrap: 'wrap', p: 0.5, m: 0 }}>
