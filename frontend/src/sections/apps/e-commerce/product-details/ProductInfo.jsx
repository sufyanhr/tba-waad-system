              ...
              <Stack sx={{ justifyContent: 'flex-end' }}>
                <Stack direction="row">
                  <TextField
                    ...
                    sx={{ width: '33%' }}
                    slotProps={{ htmlInput: { sx: { p: 1.25 } }, input: { sx: { borderRadius: 0 } } }}
                  />
                  <Stack>
                    <Button
                      key="one"
                      ...
                      sx={(theme) => ({
                        ...
                        '&.Mui-disabled': { borderLeft: 'none', borderColor: 'grey.300' },

                        ...theme.applyStyles('dark', {
                          borderColor: 'grey.200',
                          '&:hover': { borderColor: 'grey.200' },
                          '&.Mui-disabled': { borderColor: 'grey.200', '&:hover': { borderColor: 'grey.200' } }
                        })
                      })}
                    >
                    ...
                    <Button
                      ...
                      sx={(theme) => ({
                        ...
                        borderColor: 'grey.300',
                        '&:hover': { borderColor: 'grey.300' },
                        '&.Mui-disabled': { borderTop: 'none', borderLeft: 'none', borderColor: 'grey.300' },
