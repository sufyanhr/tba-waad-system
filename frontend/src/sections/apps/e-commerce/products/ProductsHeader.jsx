...
export default function ProductsHeader({ filter, handleDrawerOpen, setFilter }) {
  ...
  return (
    <MainCard content={false}>
      ...
      >
        <Stack direction="row" sx={{ gap: 2.5, alignItems: 'center', justifyContent: 'space-between', flexGrow: 1 }}>
        ...
        <Button
          ...
          sx={(theme) => ({ color: 'text.primary', borderColor: 'grey.300', ...theme.applyStyles('dark', { borderColor: 'grey.200' }) })}
        >
