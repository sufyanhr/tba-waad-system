...
export const getStyles = (currentPalette) => {
  return StyleSheet.create({
    ...
    tableHeader: {
      ...
      borderTop: `1px solid ${currentPalette.grey[200]}`,
      paddingTop: '10px',
      paddingBottom: '10px',
      margin: 0,
      paddingLeft: 10
...
export default function Content({ list, currentPalette }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <View style={[styles.row, styles.tableHeader, { backgroundColor: currentPalette.grey[100] }]}>
      ...
      <View style={[styles.row, styles.amountSection]}>
        <View style={[styles.row, styles.amountRow]}>
          ...
          <Text style={[styles.caption, { color: currentPalette.success.main }]}>${discountRate?.toFixed(2)}</Text>
        </View>
      </View>
      <View style={[styles.row, styles.amountSection]}>
        <View style={[styles.row, styles.amountRow]}>
...
Content.propTypes = { list: PropTypes.any, currentPalette: PropTypes.any };
