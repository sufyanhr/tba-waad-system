...
export default function UserDetails({ user, onClose }) {
  ...
  return (
    <MainCard
      sx={{ bgcolor: 'background.paper', borderRadius: '0 4px 4px 0', borderLeft: 'none', height: 1, minWidth: 224 }}
      content={false}
    >
      <Box sx={{ p: 2 }}>
        {onClose && (
      ...
      <Box>
        <SimpleBar sx={{ overflowX: 'hidden', height: { xs: 'auto', md: 'calc(100vh - 397px)' }, minHeight: { xs: 0, md: 420 } }}>
          <Stack sx={{ gap: 3 }}>
            <Stack direction="row" sx={{ gap: 1, justifyContent: 'center', px: 2 }}>
                  ...
                  <Stack sx={{ gap: 2, mt: 1 }}>
                    <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
                      <Stack direction="row" sx={{ gap: 1.5, alignItems: 'center' }}>
                        <Avatar sx={{ color: 'success.dark', bgcolor: 'success.lighter', borderRadius: 1 }}>
                          <FileDoneOutlined />
                        </Avatar>
                        <Stack>
