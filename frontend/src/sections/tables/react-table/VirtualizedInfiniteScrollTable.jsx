...
import { CSVExport, HeaderSort, StatusPill } from 'components/third-party/react-table';
import makeData from 'data/react-table';

const fetchSize = 25;
const queryClient = new QueryClient();

function fetchData(start, size, sorting) {
...
function ReactTable() {
  ...
  return (
    ...
    >
      <TableContainer ref={tableContainerRef} onScroll={(e) => fetchMoreOnBottomReached(e.target)} sx={{ height: 544 }}>
        <Table>
          <TableHead>
