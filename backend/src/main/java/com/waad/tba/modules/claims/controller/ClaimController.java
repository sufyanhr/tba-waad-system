package com.waad.tba.modules.claims.controller;
...
public class ClaimController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('PERMISSION_CLAIMS_SUBMIT')")
    ...
    @PreAuthorize("hasAuthority('PERMISSION_CLAIMS_APPROVE')")
    ...
    @PreAuthorize("hasAuthority('PERMISSION_CLAIMS_REJECT')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('PERMISSION_CLAIMS_DELETE')")
