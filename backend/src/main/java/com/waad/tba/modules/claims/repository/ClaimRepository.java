...
public interface ClaimRepository extends JpaRepository<Claim, Long> {
    ...
    List<Claim> findByClaimDateBetween(@Param("startDate") LocalDateTime startDate, 
    ...
    @Query("SELECT c FROM Claim c WHERE c.status = 'PENDING_REVIEW' AND c.claimDate < :cutoffDate")
